...
{
    public class RectCreator : EditorWindow
    {

        [MenuItem("Tools/HotspotUV/RectCreator")]
        private static void ShowWindow()
        {
            var window = GetWindow<RectCreator>();
            window.titleContent = new GUIContent("RectCreator");
            window.Show();
        }
